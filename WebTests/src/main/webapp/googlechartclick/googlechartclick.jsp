...
<html>
    <head>
        <title>Google Chart Clickable</title>
        <link href="../pagenotables/styles.css" rel="stylesheet" type="text/css" />
    ...
    <script src="js/newdashboard_clickable.js" type="text/javascript"></script>                
